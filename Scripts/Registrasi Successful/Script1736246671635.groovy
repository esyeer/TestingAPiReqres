...
//Define base uRL
def baseUrl = findTestObject('Object Repository/Register User')
...
assert response.getResponseText().contains("id") : "Response does not contain 'id' property"
assert response.getResponseText().contains("token") : "Response does not contain 'token' property"
assert jsonResponse.token != "" : "Missing token"
